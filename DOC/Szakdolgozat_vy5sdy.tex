...
\begin{document}
	...
	\begin{table}[!ht]
		...
		\begin{tabular}{|p{5cm}|l|}
			...
			Hálózati állapotok tesztelése                       & \multicolumn{1}{c|}{\url{https://youtu.be/WQD3qGFs3ow}}            \\ \hline
			Funkciók tesztelése postman-nel                       & \url{https://youtu.be/cqxIeAL4vKU}                                 \\ \hline
			Konfigurálás applikáción keresztül                       & \url{https://youtu.be/FdNhH-9KihU}                                 \\ \hline
			\multicolumn{1}{|p{5cm}|}{Modul csatlakoztatása és feladat létrehozása applikáción keresztül} & \url{https://youtu.be/oTmQYIAmkSo}                                 \\ \hline
		\end{tabular}
	\end{table}
	\FloatBarrier
